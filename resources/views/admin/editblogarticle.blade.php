        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <form method="POST" action="{{ url('/article', array($blogpost->id)) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="blog_title" type="text" class="form-control{{ $errors->has('blog_title') ? ' is-invalid' : '' }}" name="blog_title" value="{{ $blogpost->blog_title }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="blog_language" type="blog_language" class="form-control{{ $errors->has('blog_language') ? ' is-invalid' : '' }}" name="blog_language" required>
                                            <option value=" {{ $blogpost->language }} " selected> {{ $blogpost->language }} </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea id="blog_start_post" rows="5" class="form-control{{ $errors->has('blog_start_post') ? ' is-invalid' : '' }}" name="blog_start_post" required> {{ $blogpost->blog_start_post }} </textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea id="blog_rest_post" name="blog_rest_post" rows="7" class="form-control ckeditor{{ $errors->has('blog_rest_post') ? ' is-invalid' : ''}}" placeholder="Write your message.." required> {{ $blogpost->blog_rest_post }} </textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="blog_cover_image_alt" type="text" class="form-control{{ $errors->has('blog_cover_image_alt') ? ' is-invalid' : '' }}" name="blog_cover_image_alt" value="{{ $blogpost->blog_cover_image_alt }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="blog_meta_description" type="text" class="form-control{{ $errors->has('blog_meta_description') ? ' is-invalid' : '' }}" name="blog_meta_description" value="{{ $blogpost->blog_meta_description }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="blog_meta_keywords" type="text" class="form-control{{ $errors->has('blog_meta_keywords') ? ' is-invalid' : '' }}" name="blog_meta_keywords" value="{{ $blogpost->blog_meta_keywords }}" required autofocus>
