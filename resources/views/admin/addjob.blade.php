                    ...
                    <div class="row">
                        <form method="POST" action="{{ url('/addjob') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="job_place" type="text" class="form-control{{ $errors->has('job_place') ? ' is-invalid' : '' }}" name="job_place" value="{{ old('job_place') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="job_meta_description" type="text" class="form-control{{ $errors->has('job_meta_description') ? ' is-invalid' : '' }}" name="job_meta_description" value="{{ old('job_meta_description') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="job_meta_keywords" type="text" class="form-control{{ $errors->has('job_meta_keywords') ? ' is-invalid' : '' }}" name="job_meta_keywords" value="{{ old('job_meta_keywords') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea id="job_description" name="job_description" rows="7" class="form-control ckeditor{{ $errors->has('job_description') ? ' is-invalid' : ''}}" placeholder="Write your message.." required></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea id="job_goodtoknow" name="job_goodtoknow" rows="7" class="form-control ckeditor{{ $errors->has('job_goodtoknow') ? ' is-invalid' : ''}}" placeholder="Write your message.." required></textarea>
